...
ArrayList<TestingLabAppointment> al = (ArrayList<TestingLabAppointment>) request.getAttribute("statustestlabappointmentlist");
@SuppressWarnings("unchecked")
ArrayList<TestingLab> dl = (ArrayList<TestingLab>) request.getAttribute("statustestlabdetails"); 
