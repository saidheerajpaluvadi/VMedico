...
<tr>
<td style ="color:#cc0000;text-decoration:underline;"><form action="patientprofileedit.jsp"><button id="edit" type="submit"><i class='far fa-edit' style="font-size:18px;"></i> Edit Profile</button></form></td>
</tr>
