...
<title>Old Lab Report |VMedico</title>
<style>
...
ArrayList<TestingLabAppointment> al = (ArrayList<TestingLabAppointment>) request.getAttribute("testinglabappointmentstogivereportold");
@SuppressWarnings("unchecked")
ArrayList<Patient> dl = (ArrayList<Patient>) request.getAttribute("patientsforreportold"); 
