...
<title>New Lab Report |VMedico</title>
<style>
...
ArrayList<TestingLabAppointment> al = (ArrayList<TestingLabAppointment>) request.getAttribute("testinglabappointmentstogivereportnew");
@SuppressWarnings("unchecked")
ArrayList<Patient> dl = (ArrayList<Patient>) request.getAttribute("patientsforreportnew"); 
...
for(int i=0;i< al.size() ;i++){
	...
	<!--  -->
	<td><form action="addreport" method="POST"> <button type="submit" name="appdetails" value=<%= al.get(i).toString() %>>ADD</button> </form></td>
