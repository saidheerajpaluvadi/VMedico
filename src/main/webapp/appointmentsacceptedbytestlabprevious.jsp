...
<title>Previous Appointments |VMedico</title>
<style>
...
ArrayList<TestingLabAppointment> al = (ArrayList<TestingLabAppointment>) request.getAttribute("testinglabappointmentsacceptedprevious");
@SuppressWarnings("unchecked")
ArrayList<Patient> dl = (ArrayList<Patient>) request.getAttribute("acceptedpatientslistfortestinglabprevious"); 
